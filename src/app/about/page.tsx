        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              We're a team of supply chain experts and technologists building
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-lg shadow-elegant p-8">
                ...
                <p className="text-muted-foreground text-center">
                  &quot;A future where supply chain excellence is accessible to
                  every business— empowering companies of all sizes to compete,
              ...
              {[
                {
                  title: "Transparency",
                  description:
                    "We believe in clear, honest communication with our clients and within our team.",
                },
                {
                  title: "Innovation",
                  description:
                    "We constantly push the boundaries of what's possible in supply chain technology.",
                },
                {
                  title: "Partnership",
                  description:
                    "Your success is our success. We're committed to growing together with our clients.",
                },
              ].map((value, index) => (
